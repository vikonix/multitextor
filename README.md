...
### Tested on
Linux/Windows/OSX/FreeBSD build (Travis CI): [![Build Status](https://app.travis-ci.com/vikonix/multitextor.svg?branch=main&status=passed)](https://app.travis-ci.com/vikonix/multitextor)
